...
type
  ...
  TSurf              =class {$region -fold}
    public
      ...
      rot_arr_width          : integer;
      rot_arr_height         : integer;
  ...
  TSelPts            =class {$region -fold}
    public
      ...
      destructor  Destroy;                                                                  override; {$ifdef Linux}[local];{$endif}
      {TODO}
      procedure ChangeSelectionMode             (         item_index         :integer);       inline; {$ifdef Linux}[local];{$endif}
      {add circle}
...
begin
  with sln_var.global_prop do
    case CB_Spline_Edges_Style.ItemIndex of
      00: eds_bld_stl:=dsMonochrome;
      01: eds_bld_stl:=dsAdditive  ;
      02: eds_bld_stl:=dsAlphablend;
      03: eds_bld_stl:=dsInverse   ;
      04: eds_bld_stl:=dsHighlight ;
      05: eds_bld_stl:=dsDarken    ;
      06: eds_bld_stl:=dsGrayscaleR;
      07: eds_bld_stl:=dsGrayscaleG;
      08: eds_bld_stl:=dsGrayscaleB;
      09: eds_bld_stl:=dsMononoise ;
      10: eds_bld_stl:=dsColorizeRM;
      11: eds_bld_stl:=dsColorizeRP;
      12: eds_bld_stl:=dsColorizeGM;
      13: eds_bld_stl:=dsColorizeGP;
      14: eds_bld_stl:=dsColorizeBM;
      15: eds_bld_stl:=dsColorizeBP;
      16: eds_bld_stl:=dsBlurRGB   ;
      17: eds_bld_stl:=dsBlurRRB   ;
      18: eds_bld_stl:=dsBlurRGR   ;
      19: eds_bld_stl:=dsBlurGGB   ;
      20: eds_bld_stl:=dsBlurRGG   ;
      21: eds_bld_stl:=dsBlurBGB   ;
      22: eds_bld_stl:=dsBlurRBB   ;
      23: eds_bld_stl:=dsBlurRRR   ;
      24: eds_bld_stl:=dsBlurGGG   ;
      25: eds_bld_stl:=dsBlurBBB   ;
    end;
end; {$endregion}
...
begin
  with sln_var.global_prop do
    case CB_Spline_Points_Style.ItemIndex of
      00: pts_bld_stl:=dsMonochrome;
      01: pts_bld_stl:=dsAdditive  ;
      02: pts_bld_stl:=dsAlphablend;
      03: pts_bld_stl:=dsInverse   ;
      04: pts_bld_stl:=dsHighlight ;
      05: pts_bld_stl:=dsDarken    ;
      06: pts_bld_stl:=dsGrayscaleR;
      07: pts_bld_stl:=dsGrayscaleG;
      08: pts_bld_stl:=dsGrayscaleB;
      09: pts_bld_stl:=dsMononoise ;
      10: pts_bld_stl:=dsColorizeRM;
      11: pts_bld_stl:=dsColorizeRP;
      12: pts_bld_stl:=dsColorizeGM;
      13: pts_bld_stl:=dsColorizeGP;
      14: pts_bld_stl:=dsColorizeBM;
      15: pts_bld_stl:=dsColorizeBP;
      16: pts_bld_stl:=dsBlurRGB   ;
      17: pts_bld_stl:=dsBlurRRB   ;
      18: pts_bld_stl:=dsBlurRGR   ;
      19: pts_bld_stl:=dsBlurGGB   ;
      20: pts_bld_stl:=dsBlurRGG   ;
      21: pts_bld_stl:=dsBlurBGB   ;
      22: pts_bld_stl:=dsBlurRBB   ;
      23: pts_bld_stl:=dsBlurRRR   ;
      24: pts_bld_stl:=dsBlurGGG   ;
      25: pts_bld_stl:=dsBlurBBB   ;
    end;
end; {$endregion}
...
procedure TSelPts.ChangeSelectionMode(item_index:integer);                                                                                     inline; {$ifdef Linux}[local];{$endif} {$region -fold}
begin
...
begin
  ...
  with srf_var,tex_var do
    begin
      ...
      BorderBlur(srf_bmp_ptr,srf_bmp.width,inn_wnd_rct,0,NT_BIT_MASK_ALPHA);
      with srf_var,tex_var do
        ImgRot1
        (
          PtPos
      ...
      with rot_img do
        begin
          ...
          SetValInfo(srf_bmp_ptr,Nil,Nil,srf_bmp.width,srf_bmp.height);
      ...
      ArrClear(srf_bmp_ptr,inn_wnd_rct,rot_arr_width,0,False);
    end;

      exec_timer:=TPerformanceTime.Create;
      exec_timer.Start;
      PPFloodFill(srf_var.srf_bmp_ptr,bounding_rct,srf_var.srf_bmp.width,clGreen);
      loop_cnt:=1{00000};
      angle   :={40}{5}45;
      for i:=0 to loop_cnt-1 do
        begin
          with rot_img do
            begin
              SetRctPos(bounding_rct.left,bounding_rct.top);
      ...
      execution_time:=Trunc(exec_timer.Delay*1000);
      with srf_var,tex_var do
        Memo1.Lines.Text:='pix count         :'+IntToStr  (rot_img.nt_pix_cnt)+' px.'+#13+
  ...
  {with tlm_var do
    begin
      ...
      {Memo1.Lines.Text:='rct_val_arr[0]   :'+IntToStr(tilemap_arr2[High(tilemap_arr2)].sln_prop_var.rct_val_arr[0])+#13+
                        'rct_val_arr[1]   :'+IntToStr(tilemap_arr2[High(tilemap_arr2)].sln_prop_var.rct_val_arr[1])+#13+
                        'rct_val_arr[2]   :'+IntToStr(tilemap_arr2[High(tilemap_arr2)].sln_prop_var.rct_val_arr[2])+#13+
                        'rct_val_arr[3]   :'+IntToStr(tilemap_arr2[High(tilemap_arr2)].sln_prop_var.rct_val_arr[3])+#13+
                        'rct_val_arr[4]   :'+IntToStr(tilemap_arr2[High(tilemap_arr2)].sln_prop_var.rct_val_arr[4])+#13+
                        'pts_rct_inn_width:'+IntToStr(tilemap_arr2[High(tilemap_arr2)].sln_prop_var.pts_rct_inn_width);}
    end;}
