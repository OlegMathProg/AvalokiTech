...
begin
  ...
  for i:=0 to obj_cnt-1 do
    with obj_arr[i] do
      if ((obj_show and %00010000)=%00010000) then
...
begin
  ...
  for i:=1 to Length(obj_arr)-1 do
    if     (((obj_arr_ptr+(obj_inds_arr_ptr+i)^)^.obj_show and %00010000)<>(p_s1 and %00010000)) or
            ((obj_arr_ptr+(obj_inds_arr_ptr+i)^)^.anim_type<>ltStatic) or
