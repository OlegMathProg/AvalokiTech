...
begin
  ...
  for i:=0 to obj_cnt-1 do
    begin
      (obj_arr_ptr+obj_inds_arr_ptr^)^.world_axis_shift_centrify:=(obj_arr_ptr+obj_inds_arr_ptr^)^.world_axis_shift;
      Inc(obj_inds_arr_ptr);
    end;
end; {$endregion}
...
begin
  ...
  for i:=0 to obj_cnt-1 do
    begin
      (obj_arr_ptr+obj_inds_arr_ptr^)^.parallax_shift.x*=speed_mul.x;
      (obj_arr_ptr+obj_inds_arr_ptr^)^.parallax_shift.y*=speed_mul.y;
      Inc(obj_inds_arr_ptr);
    end;
end; {$endregion}
