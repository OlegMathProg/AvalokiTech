...
procedure FloodFillAdd256(const src,msk0   :TRGBA08);        assembler; inline;
function  NZBytesCnt128  (const src,msk1   :TRGBA04): qword; assembler; inline;
function  NZBytesCnt256  (const src,msk1   :TRGBA08): qword; assembler; inline;
...
procedure FloodFillAdd256(const src, msk0      :TRGBA08                                                                                                         );        assembler; inline; nostackframe;  {$region -fold}
asm
  vmovdqu ymm0 ,[msk0]
  vpaddd  ymm1 ,ymm0  ,[src]
  vmovdqu [src],ymm1
end; {$endregion}
function  NZBytesCnt128  (const src,{msk0,}msk1:TRGBA04                                                                                                         ): qword; assembler; inline; nostackframe;  {$region -fold}
asm
  pxor    xmm3    ,xmm3
  movdqu  xmm0    ,[src]
  pcmpeqb xmm0    ,xmm3
...
function  NZBytesCnt256  (const src,{msk0,}msk1:TRGBA08                                                                                                         ): qword; assembler; inline; nostackframe;  {$region -fold}
asm
  {TODO}
end; {$endregion}
